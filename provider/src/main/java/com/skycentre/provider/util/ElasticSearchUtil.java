...
public class ElasticSearchUtil {
	private static String ip = ConfigUtil.getEsIpAddress();
    private static int port = ConfigUtil.getEsPort();
	//private static String ip = "192.168.3.41";
    //private static int port = 9300;
    
    static org.apache.commons.logging.Log log = LogFactory.getLog(ElasticSearchUtil.class);
     ...
     * @param index
     */
    public static void delIndex(String index) {
    	try{
    ...
    public static void insertDocument(Client client, String jsonValue, String index, String type, String id) {
    	client.prepareIndex("blog_index", "blog_info", id).setSource(jsonValue).execute().actionGet(); 
    }
